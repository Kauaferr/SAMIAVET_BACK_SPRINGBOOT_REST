package br.com.SAMIAVET.SAMIAVET_BACK.dto;
...
public class ProdutosDto {
	...
	public ProdutosDto(Integer codigoBarras, String nome, Double precoCompra, Double precoVenda, Double precoDescontoVenda,
	...
	public Produtos transformaParaObjeto() {
		return new Produtos(this.codigoBarras, this.nome, this.precoCompra, this.precoVenda, this.precoDescontoVenda, this.distribuidora,
							this.empresa, this.dataRegistro, this.dataValidade, this.quantidadeEstoque
				);
	}
}
